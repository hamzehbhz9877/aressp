...
import AboutImage from "@/assets/images/Image (1).svg"
// css
import "./index.scss"
const About = () => {
    return (
        <div className="about mt-[60px] mb-[30px] container">
            <Image className="w-auto" src={AboutImage} alt={'about'} width={200} height={300}/>
            <h2>About Me</h2>
            ...
            <ul>
                ...
                <li>Conducted user research and usability testing to inform the redesign of a healthcare providers website, resulting in a 15% increase in website traffic</li>
            </ul>
            <h2>Education:</h2>
            <ul>
                <li>Bachelors degree in Graphic Design</li>
