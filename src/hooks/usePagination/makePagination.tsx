...
export const MakePagination = (
    ...
    useEffect(() => {
        ...
        if (totalPage.length < 6) {
            ...
            temp = [1, 2, 3, dotsInitial, totalPage.length-2,totalPage.length-1,totalPage.length];
            ...
            const sliced = totalPage.slice(totalPage.length - 3);
            temp = [1,2,3, dotsLeft, ...sliced];
